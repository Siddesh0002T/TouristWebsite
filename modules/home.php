                ...
                <div class="row mt-4">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-md-0 px-4">
                        ...
                        <ul class="fa-ul" style="margin-left: 1.65em;">
                            <li class="mb-3">
                                <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">3R9Q+9JF, Mhasrul-Varvandi Road,Satpur MIDC <br> Rd, Near S.M.E.S.Sanghavi College of Engineering,Nashik, Maharashtra 422202</span>
                            </li>
                            <li class="mb-3">
                                <span class="fa-li"><i class="fas fa-envelope"></i></span><span class="ms-2">gadaj209@gmail.com</span>
                            </li>
                            <li class="mb-3">
                                <span class="fa-li"><i class="fas fa-phone"></i></span><span class="ms-2">8457896325</span>
                            </li>
                        </ul>
                    </div>
                    <!--Grid column-->
    ...
    <div class="container p-4">
      <div class="row">
        <div class="col-lg-4 col-md-12 mb-4">
          ...
          <p>gadaj209@gmail.com <br>
                     8010577385 <br>
                     3R9Q+9JF, Mhasrul-Varvandi Road, <br>
                     Satpur MIDC Rd, Near S.M.E.S. <br>
                     Sanghavi College of Engineering, <br>
                     Nashik, Maharashtra 422202
          </p>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="footer-links">Apply for Job</h5>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <h5 class="footer-opening-hours">opening hours</h5>
          <table>
            <tr>
              <td>Monday - Friday:</td>
              <td>8am - 9pm</td>
